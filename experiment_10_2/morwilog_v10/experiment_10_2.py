...
if __name__=="__main__":
    ...
    header = ["prop_attacks","num_attacks","initial_ph","minimum_ph","delta_ph_0","Tmax","rho","omega","P","N","TP","FP","Alerts","B[0,1,3]","B[0,1,4]","B[0,2,5]","B[0,2,6]"]

    list_results = [header]
    for prop_attack in list_prop_attack:
        file_logs = beginning_file_logs + str(prop_attack) +"/prop_attacks_"+str(prop_attack)+".log.parsed.csv"
    ...
    write_csv_file("results_experiment_10_2.csv",list_results)
