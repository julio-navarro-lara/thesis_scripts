...
if __name__=="__main__":
    ...
    beginning_file_aasg = "../aasg/eventgen_aasg/max_step_distance_with_IP_link/max_step_distance_1branch_"
    dict_var = {
        "p_t_max":120,
        "p_learning_rate":0.4
    }
    ...
    header = ["max_step_distance","equivalence_in_seconds","Tmax","learning_rate","P","N","TP","FP","Alerts","B[0,1,3]","B[0,1,4]","B[0,2,5]","B[0,2,6]"]
