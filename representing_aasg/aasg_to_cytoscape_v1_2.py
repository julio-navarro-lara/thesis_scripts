...
#In this version we add counters and optional nodes
import sys
import json
...
def node_conversion_aasg_to_cy(input_node):
    ...
    if "optional" in input_node:
        output_node["data"]["optional"] = input_node["optional"]

    if "counter" in input_node:
        output_node["data"]["counter"] = input_node["counter"]
