...
if __name__ == "__main__":
    ...
    main("../../datasets/darpa2000/simplified_parsed_v3/dmz1_events_simplified_parsed_v3.csv","../../datasets/darpa2000/aggregated_parsed_v3/dmz1_events_simplified_aggregated_parsed_v3.csv")
    main("../../datasets/darpa2000/simplified_parsed_v3/dmz2_events_simplified_parsed_v3.csv","../../datasets/darpa2000/aggregated_parsed_v3/dmz2_events_simplified_aggregated_parsed_v3.csv")
    main("../../datasets/darpa2000/simplified_parsed_v3/inside1_events_simplified_parsed_v3.csv","../../datasets/darpa2000/aggregated_parsed_v3/inside1_events_simplified_aggregated_parsed_v3.csv")
    main("../../datasets/darpa2000/simplified_parsed_v3/inside2_events_simplified_parsed_v3.csv","../../datasets/darpa2000/aggregated_parsed_v3/inside2_events_simplified_aggregated_parsed_v3.csv")
    main("../../datasets/darpa2000/simplified_parsed_v3/No_attack1_inside1_events_simplified_parsed_v3.csv","../../datasets/darpa2000/aggregated_parsed_v3/aggregated_No_attack1_inside1_events_simplified_parsed_v3.csv")
