...
#31/12/2018
#Script to get statistics from the datasets
import sys
import csv
...
def get_difference_time(input_filepath,pos_log1,pos_log2):
    list_logs = extract_csv_file(input_filepath)

    time1 = list_logs[pos_log1][input_pos_timestamp]
    time2 = list_logs[pos_log2][input_pos_timestamp]
...
def main(input_filepath,pos_log1,pos_log2):
    ...
    get_difference_time(input_filepath,pos_log1,pos_log2)
